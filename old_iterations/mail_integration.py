...
<body>
    ...
    def send_email(self, to_email: str, subject: str, html_content: str, logo_path: str = "logo.png") -> bool:
        ...
        try:
            ...
            # Create message container - use 'related' for inline images
            ...
            # Convert message to base64 encoded string for Gmail API
    ...
    def process_and_send_emails(self, csv_file: str, log_file: str = "email_sending_log.json") -> List[Dict]:
        ...
        try:
            ...
            print(f"📧 Starting Gmail API email campaign for {len(df)} professors...")
            ...
            for index, prof in df.iterrows():
                ...
                # Send email with logo using Gmail API
                ...
                print(f"⏱️  Waiting 2 seconds before next email...")
                time.sleep(2)
            ...
            print(f"🔐 Method: Gmail API with OAuth2")
